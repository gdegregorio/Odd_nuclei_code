      subroutine Finteraction
       ...
       allocate(Fpp(1:ippmax,1:ippmax,1:ippmax,1:ippmax,0:jmax))
       allocate(Fnn(1:ipnmax,1:ipnmax,1:ipnmax,1:ipnmax,0:jmax))
       allocate(Fpn(1:ippmax,1:ippmax,1:ipnmax,1:ipnmax,0:jmax))
       Fpp=0.d0
       Fnn=0.d0
       Fpn=0.d0
       a=0
